...
//        }
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
        ...
        User user = new User(signUpRequest.getFirstname().trim(), signUpRequest.getLastname().trim(),
                signUpRequest.getUsername().trim(), signUpRequest.getEmail().trim(),
                encoder.encode(signUpRequest.getPassword().trim()));
